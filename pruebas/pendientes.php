...
<br>
	...
	<table cellpadding="0" cellspacing="0">
		...
		<?php 
		$sql="SELECT * from pedidos where estado='sin confirmar' or estado='confirmado' or estado='incompleto' order by codigo desc";
    ...
    <form method="POST" action="confirmar.php">
		...
		<tr>
			<td class="<?php  echo $valor2; ?>">A<?php echo $mostrar['codigo'] ?></td>
